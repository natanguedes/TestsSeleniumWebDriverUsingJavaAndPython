...
//		chrome.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		...
		// Launch the URL
		chrome.get("http://toolsqa.wpengine.com/automation-practice-form");
		...
		List<WebElement> rdBtn_Sex = chrome.findElements(By.name("sex"));
		...
		WebElement rdBtn_Exp = chrome.findElement(By.id("exp-2"));
		rdBtn_Exp.click();
		...
		List<WebElement> chkBx_Profession = chrome.findElements(By.name("profession"));
		...
		WebElement oCheck  = chrome.findElement(By.cssSelector("input[value='Selenium IDE']"));
		oCheck.click();
